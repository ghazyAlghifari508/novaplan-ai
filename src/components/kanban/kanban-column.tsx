...
export const KanbanColumn = forwardRef<KanbanColumnHandle, KanbanColumnProps>(
  ({ title, count, cards, highlightedCardId }, ref) => {
    ...
    return (
      <div
        ref={columnRef}
        className="flex h-full flex-1 min-w-[260px] shrink-0 flex-col rounded-xl border border-graphite bg-obsidian/40 snap-center"
      >
        {/* Column Header */}
        <div className="flex items-center justify-between border-b border-graphite px-4 py-3.5 bg-obsidian/60 rounded-t-xl">
