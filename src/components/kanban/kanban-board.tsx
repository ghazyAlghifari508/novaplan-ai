...
export function KanbanBoard({ projectId, projectName }: KanbanBoardProps) {
	...
	return (
		...
		>
			...
			>
				{!hasTasks && data?.taskStatus === "generating" ? (
					// ponytail: tasks are being generated by AI — show skeleton columns
					// instead of misleading "Buat task diagram" empty state.
