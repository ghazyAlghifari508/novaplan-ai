  ...
  return (
    <>
      <div
        ...
        className={`group relative flex cursor-pointer flex-col rounded-lg border-2 border-gray-400 bg-obsidian p-3 shadow-sm transition-all duration-200 hover:border-steel hover:shadow-md ${highlighted ? "ring-2 ring-amber animate-flash" : ""}`}
      >
