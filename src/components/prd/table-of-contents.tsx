					...
					{tocItems.map((item) => (
						<a
							...
							className={cn(
								...
								item.level === 3 &&
									"ml-3 text-(--text-secondary) hover:text-(--text-primary) dark:hover:text-[#F0F0F0]",
								item.level === 4 &&
									"ml-6 text-xs text-(--text-secondary)/70 hover:text-(--text-primary) dark:hover:text-[#F0F0F0]",
							)}
							onClick={(e) => {
								e.preventDefault();
