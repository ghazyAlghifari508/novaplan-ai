    ...
    return (
      <div ref={scrollRef} className={cn("h-full overflow-y-auto", className)}>
        <article className="prd-content mx-auto max-w-3xl px-8 pb-16 pt-8 text-mist">
          <p className="flex items-center gap-2 text-fog animate-pulse">
            <span className="inline-flex gap-1">
              <span className="w-2 h-2 rounded-full bg-fog/40 animate-bounce [animation-delay:-0.3s]"></span>
              <span className="w-2 h-2 rounded-full bg-fog/40 animate-bounce [animation-delay:-0.15s]"></span>
              <span className="w-2 h-2 rounded-full bg-fog/40 animate-bounce"></span>
            </span>
