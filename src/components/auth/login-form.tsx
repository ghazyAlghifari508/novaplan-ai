  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <div className="text-center">
        <h1 className="font-fustat text-3xl font-bold">Selamat datang kembali</h1>
        <p className="mt-2 text-text-gray">
          Login untuk melanjutkan membuat PRD
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center justify-end">
          <Link
            ...
            className="text-sm text-text-gray hover:text-primary-black transition-colors"
          >
            Lupa password?
          </Link>
        </div>
