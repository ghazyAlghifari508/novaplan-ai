...
function MaintenancePage() {
  return (
    ...
    >
      ...
      <p style={{ fontSize: '16px', maxWidth: '440px', lineHeight: 1.6, color: '#a0a0a0' }}>
        Kami sedang melakukan perpindahan techstack besar-besaran untuk memberikan performa yang lebih baik.
        Aplikasi akan segera kembali online.
      </p>
      <div
        style={{
          marginTop: '24px',
